...
function initRTL() {
  ...
  // Single symbol direction button click handler
  ...
  // Backward compatibility for segmented buttons [ LTR | RTL ]
...
function applyDirection(dir) {
  ...
  // Update single symbol direction buttons
  document.querySelectorAll('.dir-toggle-btn').forEach(btn => {
    if (isRtl) {
  ...
  // Update active state on any segmented .dir-btn elements
  document.querySelectorAll('.dir-btn').forEach(btn => {
