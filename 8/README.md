...
### 3. Visual Assets
All site imagery now uses the **Paper Worlds** collection in [assets/images/paper-worlds/](assets/images/paper-worlds/): 21 original illustrations with sculpted paper detail, teal, coral, saffron and indigo colours.

- Main hero: play-world.webp
- Community, store and guidance: community-table.webp, shop-interior.webp, game-curator.webp, shop-doorway.webp
- Five category illustrations: strategy-world.webp, card-stories.webp, family-table.webp, puzzle-labyrinth.webp, rpg-orchard.webp
- Eleven individual game and accessory images, each with distinct artwork
- Fresh native vector identity: brand-mark.svg and favicon.svg
- Every illustration includes 480px and 800px responsive versions. HTML uses descriptive alt text, explicit dimensions, srcset, and lazy loading below the hero.
- Full prompts and the asset inventory are in [IMAGE-ART-DIRECTION.md](IMAGE-ART-DIRECTION.md). Composition and crop rules are in assets/css/imagery.css.

Old photography and illustrations have been removed. Related event and gallery placements reuse appropriate new illustrations.
